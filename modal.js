...
btn3.onclick = function () {
  ...
  <button class="next-button"><img id="next" class="arrow-icon" src="./images/icons/arrow.png"/></button><div class="carousel"><img class="carousel-slide" src="/images/projects/fms-biz-staff2.png"/><img class="carousel-slide" src="/images/projects/fms-biz-staff3.png"/></div></div></div><div class="carousel-text"><p><span style="background:#E74C3C">React.js</span><span style="background:#F1C40F">Typescript</span><span style="background:#1ABC9C">React Hooks</span><span style="background:#3498DB">ESLint, Prettier</span><span style="background:#9B59B6">Create React App</span><span style="background:#A04000">Figma</span><span style="background:#148F77">git</span></p><span>법인 차량 관제 서비스 스태프 페이지로 회사에서 직원들이 빌린 법인 차량, 예약, 회원 관리 그리고
...
btn4.onclick = function () {
  ...
  <button class="next-button" ><img id="next" class="arrow-icon" src="./images/icons/arrow.png"/></button><div class="carousel"><img class="carousel-slide" src="/images/projects/fms-staff1.png"/><img class="carousel-slide" src="/images/projects/fms-staff2.png"/></div></div></div><div class="carousel-text"><p><span style="background:#E74C3C">React.js</span><span style="background:#F1C40F">Class Component</span><span style="background:#1ABC9C">CSS</span><span style="background:#3498DB">ESLint, Prettier</span><span style="background:#9B59B6">Chart.js</span><span style="background:#A04000">Figma</span><span style="background:#148F77">git</span></p><p><span>차량 관제 서비스 스태프 페이지로 주로 테이블 작업과, chart.js를 사용한 
...
closeBtn.onclick = function () {
  ...
  // console.log(modalBody.clickHandler);
  // modalBody.removeEventListener("click", onClickNext);
